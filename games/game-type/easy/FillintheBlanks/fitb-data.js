...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Data
    const questions = [
        { text: "A _____ is a linear data structure that follows the First-In-First-Out (FIFO) principle.", answer: "QUEUE" },
        { text: "In a _____, each node contains a pointer to the next node, and the last node points to NULL.", answer: "LINKED LIST" },
        { text: "A ______ is a hierarchical data structure consisting of nodes connected by edges, with one root node at the top.", answer: "TREE" },
        { text: "The ______ operation in a stack adds an element to the top.", answer: "PUSH" },
        { text: "A ______ is a data structure that maps keys to values for highly efficient lookup.", answer: "HASH TABLE" },
    ];
