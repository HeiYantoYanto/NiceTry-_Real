...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const questions = [
    { text: "The _____ search algorithm checks each element in the array sequentially until the target is found.", answer: "LINEAR" },
    { text: "For binary search, the array must be _____ to ensure correct results.", answer: "SORTED" },
    { text: "The _____ search algorithm uses a formula to estimate the position of the target based on the values at the boundaries", answer: "INTERPOLATION" },
    { text: "In _____ search, the array is divided into three parts instead of two to reduce the search space.", answer: "TERNARY" },
    { text: "The time complexity of binary search in the worst case is _____", answer: "O(LOG N)" },
];
