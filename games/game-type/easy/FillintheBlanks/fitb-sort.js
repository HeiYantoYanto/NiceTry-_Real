...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const questions = [
    { text: "The _____ algorithm repeatedly compares adjacent elements and swaps them if they are in the wrong order.", answer: "BUBBLE SORT" },
    { text: "In _____ sort, the array is divided into sorted and unsorted regions, with one element moved to its correct position in each iteration.", answer: "INSERTION" },
    { text: "The _____ sorting algorithm uses a pivot element to partition the array into two sub-arrays.", answer: "QUICK" },
    { text: "______ sort is a stable sorting algorithm that divides the array into halves, sorts them, and then merges them", answer: "MERGE" },
    { text: "The ______ algorithm builds a max-heap or min-heap and then repeatedly extracts the root element to sort the array.", answer: "HEAP" },
];
