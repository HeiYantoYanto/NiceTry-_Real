...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const questions = [
    { text: "The average case time complexity of Quick Sort is ________.", answer: "O(N LOG N)" },
    { text: "Counting Sort is not comparison-based but depends on the ________ range.", answer: "KEY" },
    { text: "The _____ sorting algorithm uses a pivot element to partition the array into two sub-arrays.", answer: "QUICK" },
    { text: "External sorting is used when data does not fit into ________.", answer: "MEMORY" },
    { text: "The lower bound of comparison-based sorting is ________ time.", answer: "O(N LOG N)" },
];
