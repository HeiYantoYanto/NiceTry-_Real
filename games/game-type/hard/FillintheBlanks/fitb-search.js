...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const questions = [
    { text: "A* search combines BFS with a ________ function.", answer: "HEURISTIC" },
    { text: "In binary search trees, the left child is always ________ than the parent.", answer: "SMALLER" },
    { text: "Depth-limited search prevents going too ________ in infinite graphs.", answer: "DEEP" },
    { text: "In _____ search, the array is divided into three parts instead of two to reduce the search space.", answer: "TERNARY" },
    { text: "In hash tables, ________ probing is one method of open addressing.", answer: "LINEAR" },
];
