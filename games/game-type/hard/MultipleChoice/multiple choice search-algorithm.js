...
document.addEventListener('DOMContentLoaded', function() {
	...
	const quiz = [
		{
			q: 'Which guarantees the shortest path in graphs with non-negative weights?',
			choices: ['DFS', 'BFS', 'Dijkstra', 'Both b and c'],
			answer: 2
		},
		{
			q: 'Which search is used in AI game trees?',
			choices: ['Binary', 'Linear', 'Minimax', 'Jump'],
			answer: 2
		},
		{
