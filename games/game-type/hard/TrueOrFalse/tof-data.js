...
document.addEventListener('DOMContentLoaded', function() {
	...
	const quiz = [
		{ q: 'Red-Black trees are always perfectly balanced.', a: false },
		{ q: 'B-trees are commonly used in file systems.', a: true },
		{ q: 'A graph can contain cycles.', a: true },
		{ q: 'A binary heap guarantees O(1) deletion.', a: false },
