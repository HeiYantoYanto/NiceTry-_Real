...
document.addEventListener('DOMContentLoaded', function() {
	...
	const quiz = [
		{ q: 'Quick Sort has a worst-case time complexity of O(n log n).', a: true },
		{ q: 'Merge Sort is always faster than Quick Sort.', a: true },
		{ q: 'Insertion Sort is not efficient for large datasets.', a: true },
		{ q: 'Heap Sort is not stable.', a: true },
		{ q: 'Quick Sort is not suitable for parallelization.', a: false },
	];
	let current = 0;
	let correct = 0;
	let wrong = 0;
