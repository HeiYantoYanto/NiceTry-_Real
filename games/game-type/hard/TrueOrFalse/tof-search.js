...
document.addEventListener('DOMContentLoaded', function() {
	...
	const quiz = [
		{ q: 'BFS always finds the shortest path in unweighted graphs.', a: true },
		{ q: 'DFS guarantees shortest path in weighted graphs.', a: false },
		{ q: 'A* search is incomplete without a heuristic.', a: true },
		{ q: 'Double hashing reduces clustering compared to linear probing.', a: true },
