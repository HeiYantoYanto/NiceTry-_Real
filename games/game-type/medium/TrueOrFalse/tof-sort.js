...
document.addEventListener('DOMContentLoaded', function() {
	...
	const quiz = [
		{ q: 'Quick Sort is an in-place sorting algorithm.', a: true },
		{ q: 'Bubble Sort is adaptive.', a: false },
		{ q: 'Merge Sort always requires recursion.', a: true },
		{ q: 'Heap Sort is based on divide and conquer.', a: false },
		{ q: 'Selection Sort is not stable.', a: true }
	];
	let current = 0;
	let correct = 0;
	let wrong = 0;
