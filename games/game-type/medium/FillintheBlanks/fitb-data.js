...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Data
    const questions = [
        { text: "A binary tree where every level is fully filled is called a ________ binary tree.", answer: "COMPLETE" },
        { text: "A graph with edges having directions is called a ________ graph.", answer: "DIRECTED" },
        { text: "A hash table resolves collisions using ________ or chaining.", answer: "OPEN ADDRESSING" },
        { text: "In a doubly linked list, each node has pointers to both previous and ________.", answer: "NEXT" },
        { text: "A stack is often implemented using either arrays or ________.", answer: "LINKED LISTS" },
    ];
