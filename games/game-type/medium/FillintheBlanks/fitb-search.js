...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const questions = [
    { text: "BFS in a tree explores nodes level by ________.", answer: "LEVEL" },
    { text: "DFS in a graph can be implemented using a ________.", answer: "STACK" },
    { text: "Interpolation search estimates the position using a ________ function.", answer: "LINEAR" },
    { text: "Binary search tree operations like insertion are O(______) on average.", answer: "LOG N" },
    { text: "In a hash table, keys are mapped to ________.", answer: "INDICES" },
];
