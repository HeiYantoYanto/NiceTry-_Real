...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const questions = [
    { text: "Quick Sort’s worst-case time complexity is ________.", answer: "O(n^2)" },
    { text: "Merge Sort requires ________ memory in addition to the input array.", answer: "EXTRA" },
    { text: "Heap Sort uses a binary ________.", answer: "HEAP" },
    { text: "Selection Sort minimizes the number of ________.", answer: "SWAPS" },
    { text: "Stable sorting algorithms preserve the ________ order of equal elements.", answer: "RELATIVE" },
];
